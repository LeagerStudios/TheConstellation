...
{
    public static void SaveData(SaveData data, string saveDirectory)
    {
    ...
    public static void Delete(string fileDirectory)
    {
        if (Directory.Exists(fileDirectory)) Directory.Delete(fileDirectory, true);
        else File.Delete(fileDirectory);
    }

    public static T LoadData<T>(string directory) where T : SaveData
    {
    ...
    public static void DeleteLastLineInTxt(string directory)
    {
        ...
        {
            List<string> exitTxtList = ReadTxt(directory).ToList();
